  ...
  const getThread = async () => {
    try {
      ...
      const {
        ...
        `${process.env.API_URL}/api/v1/thread/${thread}`,
    ...
    try {
      ...
      if (!state.sortLoad) {
        ...
        const {
          ...
          `${process.env.API_URL}/api/v1/thread/${thread}?sort=${sort}`,
          { headers: { '_token': token } }
        )
    ...
    try {
      ...
      if (!state.moreLoad) {
        ...
        const {
          ...
          `${process.env.API_URL}/api/v1/thread/${thread}?cursor=${state.paging.cursor}&sort=${state.sort}`,
          { headers: { '_token': token } }
        )
    ...
    try {
      ...
      if (!state.postLoad) {
        ...
        const {
          ...
          `${process.env.API_URL}/api/v1/thread/comment`,
          { thread, user, body },
          { headers: { '_token': token } }
        )
    ...
    try {
      ...
      if (!state.pinned.loading) {
        ...
        const {
          ...
          `${process.env.API_URL}/api/v1/thread/${thread}/pin`,
          {},
          { headers: { '_token': token } }
        )
